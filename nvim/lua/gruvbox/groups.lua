...
M.setup = function()
  ...
  local groups = {
    ...
    DiagnosticFloatingError = { fg = colors.red, bg = colors.bg0 },
    DiagnosticFloatingWarn = { fg = colors.orange, bg = colors.bg0 },
    DiagnosticFloatingInfo = { fg = colors.blue, bg = colors.bg0 },
    DiagnosticFloatingHint = { fg = colors.aqua, bg = colors.bg0 },
